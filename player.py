...
play_button.grid(row=1,column=2,padx=10)
pause_button.grid(row=1,column=1,padx=10)
stop_button.grid(row=1,column=3,padx=10)

forward_button.grid(row=1,column=4,padx=10)
